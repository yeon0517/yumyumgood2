package com.cookpang.app.userList.vo;
...
public class UserListVO {
	...
	public String toString() {
		return "UserListVO [userNumber=" + userNumber + ", userId=" + userId + ", userPassword=" + userPassword
				...
				+ userGender + ", userProfileImageSystemName=" + userProfileImageSystemName + "]";
	}
