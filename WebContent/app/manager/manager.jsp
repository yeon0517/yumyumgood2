									...
									<div class="profile">
										...
										<div class="profile-box">
											<div class="nickname-box">
												...
												<div>
													<a href="#"><img src="../img/managerImg/setting.png" alt="" id="설정" /></a>
												</div>
											</div>
										...
										<form action="/manager/UserDeleteOk.manager" method="post">
											<div class="member-main test" id="member-Menu">
												<div class="member-serch">
													<input type="text" id="user-serch" name="userSerch" placeholder="회원아이디를 입력하시오" />
													<button type="button">
																	...
																	<tr>
																		...
																		<td>
																			<div class="checkbox-c">
																				<a href="#"><input type="checkbox" name="user" class="user-check-box"
												...
												<button type="submit" class="button user-delete-btn" id="memberDelete">회원 삭제</button>
									...
									<div>
										<div class="manage-post test" id="member-post">
											<div class="post-serch">
												<input type="text" name="postSerch" id="post-search" placeholder="게시물 제목을 입력하세요" />
												<button>
													<a href="#"><i class="fa-solid fa-magnifying-glass"></i></a>
												</button>
											</div>
											<table class="post-table">
												...
												<tr>
													...
													<td>
														<div class="checkbox-c">
															<a href="#"><input type="checkbox" class="post-check-box" name="post"
																	value="#게시물번호" /></a>
														</div>
													</td>
												</tr>
									...
									<div>
										<div class="manage-payment test" id="member-payment">
											<div class="payment-serch">
												<input type="text" name="paymentSerch" id="payment-serch" placeholder="회원아이디를 입력하시오" />
												<button>
													<a href="#"><i class="fa-solid fa-magnifying-glass"></i></a>
												</button>
											...
											<table class="payment-table">
												...
												<tr>
													...
													<td>
														<div class="checkbox-c">
															<a href="#"><input type="checkbox" name="payment" class="payment-check-box"
																	value="#결제번호" /></a>
														</div>
													</td>
												</tr>
