...
<head>
  ...
  <script async defer crossorigin="anonymous" src="https://connect.facebook.net/ko_KR/sdk.js#xfbml=1&version=v10.0&appId=1588150011384568" 
    ...
    <div class="wrapper">
        ...
        <form action="/manager/managerLoginOk.manager" method="post" >
          ...
          <div class="input-group checkbox-wrap">
            ...
            <label for="remember" id="remember-id">아이디 기억하기</label>
          </div>
        </div>
          ...
          <div class="login-social">
            <div class="btn-wrap">
              <a href="javascript:void(0)" id="fbLogin" onclick="fnFbCustomLogin();" scope="public_profile, email">
                <img src="https://2bob.co.kr/skin/nodskin_argio/images/btn_login_face.jpg" alt="">
              </a>
              <a href="javascript:void(0)" id="naverIdLogin_loginButton">
                <img src="https://2bob.co.kr/skin/nodskin_argio/images/btn_login_naver.jpg" alt="">
              </a>
              <a href="javascript:void(0)" id="" onclick="kakaoLogin();">
                <img src="https://2bob.co.kr/skin/nodskin_argio/images/btn_login_kakao.jpg" alt="">
              </a>
      ...
      <div class="recover">
          <label for="find-password">비밀번호를 잊어버리셨나요?
          <a href="#">비밀번호 찾기</a>
        </label>
      </div>
    </div>
